...
def make_test_subjects
  ...
  c3 = Character.create(name:"I have no journey")
  c4 = Character.create(name:"I also have no journey")
  ...
  j3 = Journey.create(name:"Noname journey")
  j4 = Journey.create(name:"No character to speak of")
  p1 = c1.points.create(querent_ref: "p1, 16 inverted,", description: "boilerplate 1")
  p1.cards.push(Card.find(16))
  p2 = c1.points.create(querent_ref: "p2, 14 upright", description: "boilerplate 2")
  p2.cards.push(Card.find(14))
  p3 = c1.points.create(querent_ref: "p3, 18 upright, 19 inverted, 20 inverted", description: "boilerplate 3")
  Card.find(18,19,20).each {|a| p3.cards.push(a)}
  p4 = c1.points.create(querent_ref: "p4, 21 inverted, 22 inverted, 23 inverted", description: "boilerplate 4")
  Card.find(21,22,23).each {|a| p4.cards.push(a)}
  p5 = c2.points.create(querent_ref: "p1, 24 inverted", description: "boilerplate 1")
  p5.cards.push(Card.find(24))
  p6 = c2.points.create(querent_ref: "p2, 25 upright", description: "boilerplate 2")
  p6.cards.push(Card.find(25))
  p7 = c2.points.create(querent_ref: "p3, 26 upright, 27 upright, 28 upright", description: "boilerplate 3")
  Card.find(26,27,28).each {|a| p7.cards.push(a)}
  p8 = c2.points.create(querent_ref: "p4, 29 inverted, 30 upright, 31 inverted", description: "boilerplate 4")
  Card.find(29,30,31).each {|a| p8.cards.push(a)}
  p9 = j1.points.create(querent_ref: "point1, 32 inverted,", description: "boilerplate 1")
  p9.cards.push(Card.find(32))
  p10 = j1.points.create(querent_ref: "point2, 33 upright", description: "boilerplate 2")
  p10.cards.push(Card.find(33))
  p11 = j1.points.create(querent_ref: "point3, 34 upright", description: "boilerplate 3")
  p11.cards.push(Card.find(34))
  p12 = j1.points.create(querent_ref: "point4, 35 inverted", description: "boilerplate 4")
  p12.cards.push(Card.find(35))
  p13 = j2.points.create(querent_ref: "point5, 36 inverted", description: "boilerplate 1")
  p13.cards.push(Card.find(36))
  p14 = j2.points.create(querent_ref: "point6, 37 upright", description: "boilerplate 2")
  p14.cards.push(Card.find(37))
  p15 = j2.points.create(querent_ref: "point7, 38 upright", description: "boilerplate 3")
  p15.cards.push(Card.find(38))
  p16 = j2.points.create(querent_ref: "point8, 39 inverted", description: "boilerplate 4")
  p16.cards.push(Card.find(39))

  # unassociated objects
  p17 = c3.points.create(querent_ref: "p1, 40 inverted", description:"I have one inverted card")
  p17.cards.push(Card.find(40))
  p18 = c3.points.create(querent_ref: "p2, 41 inverted, 42 upright, 43 upright", description:"I have three cards, invert upright upright")
  Card.find(41,42,43).each {|a| p18.cards.push(a)}
  p19 = c4.points.create(querent_ref: "p3, 44 upright", description:"I have one upright card")
  p19.cards.push(Card.find(44))
  p20 = c4.points.create(querent_ref: "p4, 45 inverted, 46 upright, 47 upright", description:"I have three cards, upright upright invert")
  Card.find(45,46,46).each {|a| p20.cards.push(a)}
  p21 = j3.points.create(querent_ref: "point9, 47 inverted", description:"I have one inverted card")
  p21.cards.push(Card.find(47))
  p22 = j3.points.create(querent_ref: "point10, 48 inverted", description:"I have one inverted card")
  p22.cards.push(Card.find(48))
  p23 = j4.points.create(querent_ref: "point11, 49 inverted", description:"I have one upright card")
  p23.cards.push(Card.find(49))
  p24 = j4.points.create(querent_ref: "point12, 50 inverted", description:"I have one upright card")
  p24.cards.push(Card.find(50))
